...
func (f *fixture) newController() (*Controller, informers.SharedInformerFactory, kubeinformers.SharedInformerFactory) {
	...
	c := NewController(kubeClient, kubeInformerFactory.Batch().V1().Jobs())
...
func (f *fixture) expectUpdateFooStatusAction(foo *batcheslisters.Foo) {
...
func getKey(foo *batcheslisters.Foo, t *testing.T) string {
